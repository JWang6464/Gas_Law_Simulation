...
# Version 5.1 2020/03/30
#     * edits made by Bruce Maxwell, Colby College
#     * updated checkMouse and checkKey to not call win.update to avoid
#       animations slowing down by calling them
